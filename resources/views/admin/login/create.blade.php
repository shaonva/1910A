...
<center><h2>管理员管理添加</h2><hr /></center>
...
<form action="{{url('/login/store')}}" method="post" class="form-horizontal" role="form">
	@csrf
 	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="user_name" id="lastname" 
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="user_tel" id="lastname" 
				   placeholder="请输入手机号码">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="user_email" id="lastname" 
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="password" class="form-control" name="user_pwd" id="lastname" 
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="user_time" id="lastname" 
				   placeholder="请输入添加时间">
		</div>
	</div>
	<div class="form-group">
